# [am-serv00-vmess](https://github.com/fxf981/am-serv00-vmess)
...
- 2、进入到面板后复制下面代码一键安装
```
bash <(curl -Ls https://raw.githubusercontent.com/fxf981/am-serv00-vmess/main/install_serv00_vmess.sh)
```
